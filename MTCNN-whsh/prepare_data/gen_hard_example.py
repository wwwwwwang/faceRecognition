...
#net : 24(RNet)/48(ONet)
#data: dict()
def save_hard_example(net, data, image_size, save_path, neg_dir, pos_dir, part_dir):
...
def t_net(prefix, epoch,
    ...
    for dir_path in [neg_dir, pos_dir, part_dir, save_path]:
        if not os.path.exists(dir_path):
            os.makedirs(dir_path)
    print("all dirs have been made...")
    ...
    save_hard_example(image_size, data, image_size, save_path, neg_dir, pos_dir, part_dir)


def parse_args():
    parser = argparse.ArgumentParser(description='Test mtcnn',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--mode', dest='mode', help='test net type, can be pnet, rnet or onet',
